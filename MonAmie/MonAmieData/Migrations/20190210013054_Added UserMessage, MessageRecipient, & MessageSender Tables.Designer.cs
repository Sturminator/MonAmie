...
namespace MonAmieData.Migrations
{
    ...
    [Migration("20190210013054_Added UserMessage, MessageRecipient, & MessageSender Tables")]
    partial class AddedUserMessageMessageRecipientMessageSenderTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonAmieData.Models.UserMessage", b =>
                {
                    b.HasOne("MonAmieData.Models.MessageRecipient", "MessageRecipient")
                        .WithMany()
                        .HasForeignKey("MessageRecipientId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MonAmieData.Models.MessageSender", "MessageSender")
                        .WithMany()
